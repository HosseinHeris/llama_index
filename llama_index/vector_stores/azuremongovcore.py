...
class AzureMongovCoreVectorSearch(VectorStore):
    ...
    def __init__(
        ...
        db_name: str = "default_db6",
        collection_name: str = "default_collection6",
    ...
    def _create_vector_search_index(self):  
        print('creating search index on:', self._db_name)
